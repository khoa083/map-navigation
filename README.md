...
<p align="center">
  <strong>Kblack: Offline Map Navigation là một ứng dụng chỉ đường ngoại tuyến dành cho Android sử dụng thư viện Graphhopper để xử lý các thuật toán tìm đường và Maplibre hiển thị map.</strong>
</p>
